...
func (s *Server) registerForm(w http.ResponseWriter, r *http.Request) {
	...
	s.render(w, "register.html", pageData{Title: "Assimilate", CSRFToken: csrfTok, ContentTemplate: "register_content"})
}
...
func (s *Server) registerSubmit(w http.ResponseWriter, r *http.Request) {
	...
	if accessCode == "" {
		s.render(w, "register.html", pageData{
			Title: "Assimilate", Flash: "Access code is required.", CSRFToken: csrfTok, ContentTemplate: "register_content",
		})
		return
	}
	...
	if err != nil {
		if errors.Is(err, store.ErrDroneExists) {
			...
			if err != nil {
				...
				s.render(w, "register.html", pageData{Title: "Assimilate", Flash: flash, CSRFToken: csrfTok, ContentTemplate: "register_content"})
				return
			}
		} else {
...
func (s *Server) loginForm(w http.ResponseWriter, r *http.Request) {
	...
	s.render(w, "login.html", pageData{Title: "Connect", CSRFToken: csrfTok, ContentTemplate: "login_content"})
}
